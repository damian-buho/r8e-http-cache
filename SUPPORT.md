...
Thanks for using **R8E / HTTP Cache (unofficial b19-style image)**!
...
- **Report a reproducible bug** — [Issues on Codeberg](https://codeberg.org/r8e/http-cache/issues)
- **Report a reproducible bug** — [Issues on GitHub](https://github.com/damian-buho/r8e-http-cache/issues)
...
4. **Environment** — OS, version of R8E / HTTP Cache (unofficial b19-style image), runtime version.
