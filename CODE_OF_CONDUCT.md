...
We pledge to make participation in [R8E / HTTP Cache](README.md) welcoming, safe, and
...
when an individual is officially representing [R8E / HTTP Cache](README.md) in public
spaces.
